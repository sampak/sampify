...
function Liked(){
  ...
  useEffect(() => {
    const isPlaylist = playlists.find((playlist: PlaylistInterface) => playlist.playlistGuid === 'LIKED_SONGS');
    const newPlaylist = {
  ...
  return <Playlist playlistGuid={'LIKED_SONGS'} refetch={refetchHome} songs={songs ?? []} />
}
