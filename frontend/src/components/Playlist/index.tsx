    ...
    <SC.Playlist onDragEnter={() => setDragFile(true)}>
      ...
      <SC.PlaylistData>
        <SC.PlaylistInformation>
          ...
          <SC.PlaylistDescription>
            A daily selection of chill beats perfect to help you to relax and
            study
          </SC.PlaylistDescription>
          <SC.Info>
            <SC.CreatedBy>
              Created by <b>Sampak</b>
            </SC.CreatedBy>
            <SC.Songs>
              {songs.length} Songs {milisToHoursAndSeconds(durationInMs)}
            </SC.Songs>
          </SC.Info>
        </SC.PlaylistInformation>
        <SC.PlaylistCover>
      ...
      <SC.Options>
        ...
        <SC.Settings>
          <SC.Box onClick={handleClickPlayButton}>
            ...
            player.activePlaylistGuid === playlistGuid ? (
          ...
          <SC.Box>
            ...
            <SC.TextWithPadding>2.9m</SC.TextWithPadding>
          </SC.Box>
          <SC.Box>
